...
> Still open: interactive mode (2.15, decide implement-or-remove), the dead-module adopt-or-delete (2.16), EventBus refactor (3.1), skeptic credibility-challenge targeting (3.4), `datetime.utcnow()` sweep, SQLite-on-volume, and remaining doc sync. Line numbers refer to the commit the review was written against.
