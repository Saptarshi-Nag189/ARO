...
class SynthesisAgent(BaseAgent):
    ...
    def get_system_prompt(self) -> str:
        return (
            ...
            "RESOLUTION DUTIES:\n"
            "- The prompt lists OPEN CONTRADICTIONS and UNRESOLVED KNOWLEDGE "
            "GAPS. When the current evidence genuinely settles one, report it "
            "in resolved_contradictions (claim_id_a, claim_id_b, resolution) "
            "or resolved_gap_ids\n"
            "- Only reference pairs/IDs that appear in those lists\n"
            "- Never mark anything resolved speculatively\n\n"
